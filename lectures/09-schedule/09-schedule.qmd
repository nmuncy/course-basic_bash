...
- Preferred: Load in project environment
    - See [Module 2.5](../11-proj_envs/11-proj_envs.qmd){target="_blank"}
:::
...
- Tips:
    ...
    - Consider parent and child jobs via [tmux](https://www.redhat.com/en/blog/introduction-tmux-linux)
